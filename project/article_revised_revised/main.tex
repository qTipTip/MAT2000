...
\begin{document}
    ...
    \begin{abstract}
       ...
       needed mathematical preliminaries. \Cref{sec:intro} motivates the
    ...
    $n$-space}\index{affine $n$-space} over $K$ to be the set of all $n$-tuples
    ...
    \begin{definition}[Algebraic surface\index{algebraic surface}]
        ...
        \emph{degree}\index{algebraic surface!degree} of an algebraic surface
